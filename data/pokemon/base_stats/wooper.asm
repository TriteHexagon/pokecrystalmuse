	...
	; tm/hm learnset
	tmhm TOXIC, ROCK_SMASH, HIDDEN_POWER, WATER_PULSE, ICE_BEAM, BLIZZARD, PROTECT, RAIN_DANCE, IRON_TAIL, EARTHQUAKE, RETURN, DIG, MUD_SHOT, SLUDGE_BOMB, SANDSTORM, SLEEP_TALK, SCALD, REST, ATTRACT, SURF, FLASH, WHIRLPOOL, WATERFALL, HEADBUTT, DEFENSE_CURL, CURSE, ICY_WIND, ENDURE, SWAGGER, ICE_PUNCH, ROLLOUT, MUD_SLAP, DOUBLE_TEAM, EARTH_POWER, DRAIN_PUNCH,SUBSTITUTE
	; end
