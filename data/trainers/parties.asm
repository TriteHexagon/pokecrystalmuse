...
BrunoGroup:
	...
	db 62, HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, PROTECT
	db 62, HITMONLEE,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 62, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 63, ONIX,       WRAP, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 66, MACHAMP,    ROCK_SLIDE, FORESIGHT, SUBMISSION, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "Karen@", TRAINERTYPE_MOVES
	db 47, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FEINT_ATTACK, MEAN_LOOK
	db 47, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 48, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 47, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FEINT_ATTACK
	db 49, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end

	; KAREN (2)
	db "Karen@", TRAINERTYPE_MOVES
	db 62, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FEINT_ATTACK, MEAN_LOOK
	db 62, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 65, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 64, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FEINT_ATTACK
...
ChampionGroup:
	...
	db 47, GYARADOS,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, TRANSFORM, THUNDER, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, TRANSFORM, BLIZZARD, HYPER_BEAM
