...
KogaGroup:
	...
	db 44, ARIADOS,    DOUBLE_TEAM, TRANSFORM, BATON_PASS, GIGA_DRAIN
	db 45, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 46, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	...
	; KOGA (2)
	db "Koga@", TRAINERTYPE_MOVES
	db 60, ARIADOS,    DOUBLE_TEAM, TRANSFORM, BATON_PASS, GIGA_DRAIN
...
BrunoGroup:
	...
	db 46, HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, PROTECT
	db 46, HITMONLEE,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 46, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 47, ONIX,       WRAP, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 48, MACHAMP,    ROCK_SLIDE, FORESIGHT, SUBMISSION, CROSS_CHOP
	db -1 ; end
