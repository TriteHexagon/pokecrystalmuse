...
WillGroup:
	...
	db 40, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 41, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, TRANSFORM, PSYCHIC_M
	db 41, SLOWKING,   QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	...
	db 61, EXEGGUTOR,  REFLECT, LEECH_SEED, STOMP, PSYCHIC_M
...
KogaGroup:
	...
	db 40, ARIADOS,    DOUBLE_TEAM, TRANSFORM, BATON_PASS, GIGA_DRAIN
...
ChampionGroup:
	...
	db 47, DRAGONITE,  THUNDER_WAVE, TRANSFORM, THUNDER, HYPER_BEAM
	db 47, DRAGONITE,  THUNDER_WAVE, TRANSFORM, BLIZZARD, HYPER_BEAM
