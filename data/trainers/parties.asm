...
CooltrainerMGroup:
	...
	db 27, CHARMELEON, EMBER, SMOKESCREEN, FURY_ATTACK, SCARY_FACE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 36, PORYGON,    RECOVER, PSYCHIC_M, TRANSFORM, TRI_ATTACK
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "Brent@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, TRANSFORM, SOFTBOILED
	db -1 ; end
...
FisherGroup:
	...
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_PULSE
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_PULSE
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, REMORAID,   PSYBEAM, AURORA_BEAM, WATER_PULSE, HYPER_BEAM
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 30, KOFFING,    TACKLE, EXPLOSION, VENOSHOCK, SMOKESCREEN
	db 30, KOFFING,    TACKLE, POISON_GAS, VENOSHOCK, SMOKESCREEN
	db -1 ; end
