...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, TRANSFORM, PROTECT
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, TRANSFORM, PROTECT
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, TRANSFORM, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER, TRANSFORM, HARDEN
	db -1 ; end
