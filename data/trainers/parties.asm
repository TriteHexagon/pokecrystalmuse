...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, TRANSFORM, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, TRANSFORM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, FURY_ATTACK, TRANSFORM, FURY_SWIPES
	db 30, POLIWRATH,  HYPNOSIS, LOCK_ON, SURF, TRANSFORM
	db -1 ; end
...
BlackbeltGroup:
	...
	db 25, MACHOP,     LEER, FOCUS_ENERGY, TRANSFORM, SEISMIC_TOSS
	db 25, MACHOKE,    LEER, TRANSFORM, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
