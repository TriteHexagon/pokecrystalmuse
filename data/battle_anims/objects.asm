...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_4E, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_CLAMP - modified for shell smash
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON ; ANIM_OBJ_GUNK_SHOT
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_14, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, ANIM_GFX_ICE ; ANIM_OBJ_POWER_GEM
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_14, BATTLEANIMFUNC_4D, PAL_BATTLE_OB_GRAY, ANIM_GFX_ICE ; ANIM_OBJ_POWER_GEM_2
