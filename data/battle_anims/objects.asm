...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_01, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_GENERIC_HIT
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_05, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_PAW
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_06, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_FANG
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_07, BATTLEANIMFUNC_09, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_PUNCH
	...
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_33, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, ANIM_GFX_LIGHTNING ; ANIM_OBJ_THUNDER
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_3A, BATTLEANIMFUNC_16, PAL_BATTLE_OB_GRAY, ANIM_GFX_CUT ; ANIM_OBJ_CLAMP - modified for shell smash
	...
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_4D, BATTLEANIMFUNC_1D, PAL_BATTLE_OB_GRAY, ANIM_GFX_EGG ; ANIM_OBJ_EGG - modified for seedbomb
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_69, BATTLEANIMFUNC_01, PAL_BATTLE_OB_GRAY, ANIM_GFX_SAND ; ANIM_OBJ_SAND_MUD
	...
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_A0, BATTLEANIMFUNC_16, PAL_BATTLE_OB_GRAY, ANIM_GFX_OBJECTS ; ANIM_OBJ_HANDS
	battleanimobj RELATIVE_X | X_FLIP, $70, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_43, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS ; ANIM_OBJ_STAR
	...
	;new
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_2A, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BROWN, ANIM_GFX_WATER ; ANIM_OBJ_EARTH_POWER
	battleanimobj RELATIVE_X, $aa, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_10, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_SOUL_EMBER
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_36, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_SMALL_ROCK_UP
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_1E, PAL_BATTLE_OB_RED, ANIM_GFX_SPEED ; ANIM_OBJ_FIRE_PARTICLES
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_PSYCHIC ; ANIM_OBJ_WATER_WAVE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_18, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE ; ANIM_OBJ_CALM_MIND_1
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_44, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE ; ANIM_OBJ_CALM_MIND_2
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_36, PAL_BATTLE_OB_GRAY, ANIM_GFX_GLOBE ; ANIM_OBJ_MOON
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_GLOBE ; ANIM_OBJ_STATIC_MOON
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_9E, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, ANIM_GFX_ANGELS ; ANIM_OBJ_DRAINING_KISS
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_04, PAL_BATTLE_OB_RED, ANIM_GFX_EXPLOSION ; ANIM_OBJ_SIGNAL_BEAM_RED
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_04, PAL_BATTLE_OB_YELLOW, ANIM_GFX_EXPLOSION ; ANIM_OBJ_SIGNAL_BEAM_YELLOW
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_04, PAL_BATTLE_OB_GREEN, ANIM_GFX_EXPLOSION ; ANIM_OBJ_SIGNAL_BEAM_GREEN
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_04, PAL_BATTLE_OB_BLUE, ANIM_GFX_EXPLOSION ; ANIM_OBJ_SIGNAL_BEAM_BLUE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_REFLECT ; ANIM_OBJ_RAZOR_SHELL
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_AC, BATTLEANIMFUNC_44, PAL_BATTLE_OB_RED, ANIM_GFX_WIND ; ANIM_OBJ_BULK_UP
	battleanimobj RELATIVE_X, $48, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_34, PAL_BATTLE_OB_BROWN, ANIM_GFX_FLOWER ; ANIM_OBJ_QUIVER_DANCE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_5D, BATTLEANIMFUNC_22, PAL_BATTLE_OB_GREEN, ANIM_GFX_SPEED ; ANIM_OBJ_ENERGY_BALL
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_04, PAL_BATTLE_OB_RED, ANIM_GFX_EGG ; ANIM_OBJ_FOCUS_BLAST
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, ANIM_GFX_PSYCHIC ; ANIM_OBJ_BUG_WAVE_1
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BROWN, ANIM_GFX_PSYCHIC ; ANIM_OBJ_BUG_WAVE_2
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_06, PAL_BATTLE_OB_BROWN, ANIM_GFX_SAND ; ANIM_OBJ_MUD_SHOT
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_07, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_BIG_ICICLE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_07, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS ; ANIM_OBJ_SMALL_ICICLE
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_EGG ; ANIM_OBJ_SCALD
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_15, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, ANIM_GFX_ICE ; ANIM_OBJ_ICE_SHARD
	battleanimobj RELATIVE_X | X_FLIP, $48, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_34, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE ; ANIM_OBJ_VAPOR
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_01, PAL_BATTLE_OB_GRAY, ANIM_GFX_EGG ; ANIM_OBJ_GUNK_SHOT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_01, PAL_BATTLE_OB_BROWN, ANIM_GFX_ICE ; ANIM_OBJ_POWER_GEM
