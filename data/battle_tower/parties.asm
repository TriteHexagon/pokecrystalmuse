...
BattleTowerMons1:
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_TAIL, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons2:
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, TRANSFORM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons3:
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, TRANSFORM, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db JYNX
	db GOLD_BERRY
	db BLIZZARD, LOVELY_KISS, DREAM_EATER, ATTRACT ;actual Lovely Kiss
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db DOUBLE_KICK, TRANSFORM, FLAIL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, TRANSFORM, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PORYGON2
	db NO_ITEM
	db TRANSFORM, CONVERSION, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MUK
	db QUICK_CLAW
	db SCREECH, TOXIC, VENOSHOCK, HARDEN
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons5:
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SURF, RAIN_DANCE, THUNDER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons6:
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, TRANSFORM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons7:
	...
	db UMBREON
	db GOLD_BERRY
	db FEINT_ATTACK, MOONLIGHT, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HITMONLEE
	db FOCUS_BAND
	db FLAIL, ENDURE, BODY_SLAM, TRANSFORM
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons8:
	...
	db JYNX
	db QUICK_CLAW
	db LOVELY_KISS, BLIZZARD, DREAM_EATER, PSYCHIC_M ;actual Lovely Kiss
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
