...
BattleTowerMons3:
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, DRAIN_PUNCH, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	...
	db PRIMEAPE
	db LUM_BERRY
	db DOUBLE_KICK, THRASH, FLAIL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, DRAIN_PUNCH, STONE_EDGE
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PORYGON2
	db NO_ITEM
	db THUNDERBOLT, CONVERSION, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 224, 213, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db PSYCHIC_M, STOMP, CONFUSION, ENERGY_BALL
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
