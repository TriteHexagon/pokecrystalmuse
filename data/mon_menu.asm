...
; moves
	db MONMENU_FIELD_MOVE, MONMENUITEM_CUT,        CUT        ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLY,        FLY        ;HM
	db MONMENU_FIELD_MOVE, MONMENUITEM_SURF,       SURF       ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRENGTH,   STRENGTH   ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_FLASH,      FLASH      ;HM
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATERFALL,  WATERFALL  ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_WHIRLPOOL,  WHIRLPOOL  ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_DIG,        DIG        ;TM
	db MONMENU_FIELD_MOVE, MONMENUITEM_TELEPORT,   TELEPORT   
	db MONMENU_FIELD_MOVE, MONMENUITEM_SOFTBOILED, SOFTBOILED
	db MONMENU_FIELD_MOVE, MONMENUITEM_HEADBUTT,   HEADBUTT   ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_ROCKSMASH,  ROCK_SMASH ;OPTIONAL
	db MONMENU_FIELD_MOVE, MONMENUITEM_MILKDRINK,  MILK_DRINK 
	db MONMENU_FIELD_MOVE, MONMENUITEM_SWEETSCENT, SWEET_SCENT;Tutor
; options
