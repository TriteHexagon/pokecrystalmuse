...
GoldenrodUndergroundWarehouseTMShadowCLaw:
...
GoldenrodUndergroundWarehouse_MapEvents:
	...
	object_event 13,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, GoldenrodUndergroundWarehouseTMShadowCLaw, EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_TM_SHADOW_CLAW
