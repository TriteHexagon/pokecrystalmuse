...
SlowpokeWellB2F_MapEvents:
	...
	object_event 15,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SlowpokeWellB2FTMVenoshock, EVENT_SLOWPOKE_WELL_B2F_TM_RAIN_DANCE
