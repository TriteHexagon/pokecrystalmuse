	...
	const ROUTE40_POKEBALL_THUNDER_WAVE
...
Route40_MapEvents:
	...
	object_event 15, 32, SPRITE_OLIVINE_RIVAL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 5, TrainerSwimmermRandall, -1
	...
	object_event 16, 26, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, Route40TMThunderWave, EVENT_ROUTE_40_TM_THUNDER_WAVE
