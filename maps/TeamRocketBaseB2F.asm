...
RocketBaseBossFScript:
	...
	loadtrainer EXEC_ARIANA, EXEC_ARIANA_2
	startbattle
	...
	setevent EVENT_BEAT_ROCKET_EXEC_ARIANA_2
	opentext
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  3, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, TeamRocketBaseB2FTMDarkPulse, EVENT_TEAM_ROCKET_BASE_B2F_TM_DARK_PULSE
