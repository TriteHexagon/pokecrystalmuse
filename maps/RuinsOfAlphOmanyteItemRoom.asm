...
RuinsOfAlphOmanyteItemRoom_MapEvents:
	...
	db 4 ; object events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphOmanyteItemRoomMysteryberry, EVENT_PICKED_UP_LEPPA_BERRY_FROM_OMANYTE_ITEM_ROOM
