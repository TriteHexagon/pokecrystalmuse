roms := pokemusecrystal.gbc pokemusecrystal11.gbc pokemusecrystal_au.gbc pokemusecrystal_debug.gbc pokemusecrystal11_debug.gbc
...
pokemusecrystal_obj         := $(rom_obj:.o=.o)
pokemusecrystal11_obj       := $(rom_obj:.o=11.o)
pokemusecrystal_au_obj      := $(rom_obj:.o=_au.o)
pokemusecrystal_debug_obj   := $(rom_obj:.o=_debug.o)
pokemusecrystal11_debug_obj := $(rom_obj:.o=11_debug.o)
...
all: crystal
crystal:         pokemusecrystal.gbc
crystal11:       pokemusecrystal11.gbc
crystal_au:      pokemusecrystal_au.gbc
crystal_debug:   pokemusecrystal_debug.gbc
crystal11_debug: pokemusecrystal11_debug.gbc

clean:
	rm -f $(roms) $(pokemusecrystal_obj) $(pokemusecrystal11_obj) $(pokemusecrystal_au_obj) $(pokemusecrystal_debug_obj) $(pokemusecrystal11_debug_obj) $(roms:.gbc=.map) $(roms:.gbc=.sym) rgbdscheck.o
...
$(pokemusecrystal_obj):         RGBASMFLAGS +=
$(pokemusecrystal11_obj):       RGBASMFLAGS += -D _CRYSTAL11
$(pokemusecrystal_au_obj):      RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL_AU
$(pokemusecrystal_debug_obj):   RGBASMFLAGS += -D _DEBUG
$(pokemusecrystal11_debug_obj): RGBASMFLAGS += -D _CRYSTAL11 -D _DEBUG
...
$(foreach obj, $(pokemusecrystal_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(pokemusecrystal11_obj), $(eval $(call DEP,$(obj),$(obj:11.o=.asm))))
$(foreach obj, $(pokemusecrystal_au_obj), $(eval $(call DEP,$(obj),$(obj:_au.o=.asm))))
$(foreach obj, $(pokemusecrystal_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(pokemusecrystal11_debug_obj), $(eval $(call DEP,$(obj),$(obj:11_debug.o=.asm))))

endif


pokemusecrystal_opt         = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokemusecrystal11_opt       = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokemusecrystal_au_opt      = -Cjv -t PM_CRYSTAL -i BYTU -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokemusecrystal_debug_opt   = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokemusecrystal11_debug_opt = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
