...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLGIRL_ANNA
...
; Picnicker
	...
	const EVENT_BEAT_SCHOOLGIRL_KIM
...
; Lass
	const EVENT_BEAT_SCHOOLGIRL_CARRIE
...
;new
	...
	const EVENT_APPEAR_DOJO_TRAINER
	const EVENT_ROUTE_40_TM_THUNDER_WAVE

; Unused: next 48-4 events
