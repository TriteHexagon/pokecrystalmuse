...
; Johto story events
	...
	const EVENT_GOT_TM05_DAZZLINGLEAM_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_LINK_CABLE_FROM_RADIO_TOWER
	...
	const EVENT_GOT_TM02_HEADBUTT ;unused
	...
	const EVENT_GOT_NUGGET_ROUTE_28
	const EVENT_GOT_TM34_FOCUS_BLAST
...
; Johto hidden items
	...
	const EVENT_ROUTE_34_HIDDEN_SILVER_LEAF
	const EVENT_ROUTE_37_HIDDEN_ETHER
	const EVENT_ROUTE_39_HIDDEN_NUGGET
	const EVENT_ROUTE_40_HIDDEN_SILVER_LEAF
	...
	const EVENT_SILVER_CAVE_OUTSIDE_HIDDEN_GOLD_LEAF
...
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_PATH_HIDDEN_X_SP_DEF
	...
	const EVENT_ROUTE_13_HIDDEN_ZINC
	const EVENT_ROUTE_11_HIDDEN_SILVER_LEAF
	...
	const EVENT_TIFFANY_GAVE_SILK_SCARF

	const EVENT_GOT_TM16_HYPER_BEAM
...
; More Johto story events
	...
	const EVENT_CONTEST_OFFICER_HAS_GOLD_LEAF
...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLBOY_MACY
	const EVENT_BEAT_SCHOOLBOY_JOE
	const EVENT_BEAT_SCHOOLGIRL_SUE
	const EVENT_BEAT_SCHOOLBOY_CHAD
	const EVENT_BEAT_SCHOOLBOY_NATE
	const EVENT_BEAT_SCHOOLGIRL_TIERA
...
; GruntM
	const EVENT_BEAT_EXEC_PROTON_1
...
; ExecutiveF
	const EVENT_BEAT_ROCKET_EXEC_ARIANA_1
	const EVENT_BEAT_ROCKET_EXEC_ARIANA_2
; ExecutiveM
	const EVENT_BEAT_ROCKET_EXEC_ARCHER_1
	const EVENT_BEAT_ROCKET_EXEC_PROTON_2
	const EVENT_BEAT_ROCKET_EXEC_PETREL_2
	const EVENT_BEAT_ROCKET_EXEC_PETREL_1
; Sailor
...
;new
	const EVENT_BEAT_DOJO_MORNING_TRAINER
	const EVENT_BEAT_DOJO_DAY_TRAINER
	const EVENT_BEAT_DOJO_NIGHT_TRAINER
	const EVENT_BEAT_SKIER_ANDREA
	const EVENT_BEAT_SKIER_LEXIE
	const EVENT_BEAT_SKIER_KAITLYN
	const EVENT_BEAT_BOARDER_BJORN
	const EVENT_BEAT_BOARDER_EDWARD
	const EVENT_BEAT_COOLTRAINER_SALMA
	const EVENT_BEAT_COOLTRAINER_IDA
	const EVENT_BEAT_COOLTRAINER_ARABEL
	const EVENT_BEAT_COOLTRAINER_ELAN
; Unused: next 116-12 events
...
; Johto itemballs
	...
	const EVENT_BURNED_TOWER_B1F_TM_WILL_O_WISP
	...
	const EVENT_UNION_CAVE_B1F_TM_WORK_UP
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_STEEL_WING
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_TM_DARK_PULSE
	...
	const EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_TM_SHADOW_CLAW
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_TM_IRON_HEAD
	...
	const EVENT_MOUNT_MORTAR_B1F_EVIOLITE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_ICE_BEAM
	...
	const EVENT_ROUTE_27_TM_SHADOW_BALL
...
; New to Crystal
	...
	const EVENT_SILVER_CAVE_ROOM_2_ZINC
...
;new
	...
	const EVENT_APPEAR_DOJO_MONDAY_TRAINER
	const EVENT_APPEAR_DOJO_TUESDAY_TRAINER
	const EVENT_APPEAR_DOJO_WEDNESDAY_TRAINER
	const EVENT_APPEAR_DOJO_THURSDAY_TRAINER
	const EVENT_APPEAR_DOJO_FRIDAY_TRAINER
	const EVENT_APPEAR_DOJO_SATURDAY_TRAINER
	const EVENT_APPEAR_DOJO_SUNDAY_TRAINER
	const EVENT_ROUTE_40_TM_THUNDER_WAVE

; Unused: next 48-10 events
