...
;night
	...
	;const MUSIC_GSC_VIRIDIANCITY_NIGHT
	;const MUSIC_GSC_ROUTE3_NIGHT
	;const MUSIC_GSC_ROUTE12_NIGHT
	;const MUSIC_GSC_CELADON_CITY_NIGHT
	;const MUSIC_GSC_VERMILION_CITY_NIGHT
	;const MUSIC_GSC_PALLET_TOWN_NIGHT
	;const MUSIC_GSC_ROUTE1_NIGHT
	;const MUSIC_GSC_LAVENDER_TOWN_NIGHT
	;const MUSIC_GSC_KANTO_WILD_BATTLE_NIGHT
